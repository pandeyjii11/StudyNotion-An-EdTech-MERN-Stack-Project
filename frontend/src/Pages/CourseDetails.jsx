...
const CourseDetails = () => {
    ...
    const [totalNoOdLectures, setTotalNoOfLectures] = useState(0);
    const [confirmationModl, setConfirmationModal] = useState(null);
    ...
    const getCourseFullDetails = async() => {
        ...
        try {
            ...
            // console.log(result?.data?.courseDetails);
    ...
    useEffect(() => {
        const count = GetAvgRating(courseData?.data?.courseDetails[0]?.ratingsAndReviews);
    ...
    const handleBuyCourse = () => {
        ...
        setConfirmationModal({
            ...
            text2: "Please Login to purchase th ecourse",
            btn1Text: "Login",
            btn2Texh: "Cancel",
    ...
    // console.log(courseData?.data?.courseDetails[0]._id);
    ...
    // console.log("Duration: ", courseData?.data?.timeDuration);
    ...
    return (
        <>
          ...
          <Footer />
          {confirmationModl && <ConfirmationModal modalData={confirmationModl} />}
        </>
      )
    // }
