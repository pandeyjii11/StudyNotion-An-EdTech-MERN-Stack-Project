                            ...
                            <div className="px-6 pb-4">
                                {
                                    section.subSection.map( (data) => (
                                        ...
                                        className="flex cursor-pointer items-center justify-between gap-x-3 border-b-2 
                                        border-b-richblack-600 py-2"
                                        >
