...
const Navbar = () => {
    ...
    const fetchSubLinks = async() => {
        ...
        try {
            ...
            console.log("Could not fetch the categoried list: ", error);
        }
        setLoading(false);
    }
    ...
    return(
        <div className={`flex h-14 items-center justify-center border-b-[1px] border-b-richblack-700 ${
            ...
            <div className="flex w-11/12 max-w-maxContent items-center justify-between">
                {/* image */}
                <Link to="/">
                    <img src={Logo} alt="Logo Img" width={160} height={32} loading="lazy"/>
                </Link>
...

                    {
                        token === null && (
                            <Link to={"/signup"}>
                                ...
                                py-[8px] text-richblack-100 rounded-[8px]">
                                    Sign up
                                </button>
                            </Link>
                        )
