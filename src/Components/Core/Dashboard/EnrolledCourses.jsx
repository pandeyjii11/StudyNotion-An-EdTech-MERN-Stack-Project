...
const EnrolledCourses = () => {
    ...
    const getEnrolledCourses = async() => {
        try {
            ...
            console.log("IN Enrolled COURSE RESULT: ", response);
        }
        catch(err) {
        ...
        <div>
            <div className="text-3xl text-richblack-50">Enrolled Courses</div>
            {
                ...
                (
                    ...
                    (
                        <p className="grid h-[10vh] w-full place-content-center text-richblack-5">You have now enrolled in any courses yet</p>
                    ) : (
