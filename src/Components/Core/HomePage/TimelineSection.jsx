                            ...
                            return (
                                <div key={index} className="flex flex-col lg:gap-3">
                                    <div className="flex flex-row gap-6">
                                        <div className="w-[52px] h-[52px] bg-white rounded-full flex justify-center 
                                        items-center shadow-[#00000012] shadow-[0_0_62px_0]">
                                            <img src={element.Logo} alt="TimelineImg"/>
                                        </div>
                                        <div>
                                    ...
                                    <div className={`h-14 border-r border-dotted w-[26px] border-richblack-100 
                                    bg-richblack-400/0 hidden ${timeline.length-1 === index ? "hidden": "lg:block"}`}>
                                    </div>
                                </div>
                            )
                        })
